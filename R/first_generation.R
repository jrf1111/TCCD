...
#'
#' @param Mother_Educ_Level The highest level of educational attainment of the student's mother.
#' @param Father_Educ_Level The highest level of educational attainment of the student's father.
#' @param method What definition of "first generation student" to use.
#' Use \code{method = "tcc"} to use the internal definition (student is first generation if mom \emph{and} dad have no college); this definition is mainly used internally for reports such as the extended campus profiles.
#' Use \code{method = "fed"} to use the federal definition (student is first generation if mom \emph{and} dad have no bachelor's degree); this definition is used for grant requests.
...
#'
#' @examples
first_generation = function(Mother_Educ_Level, Father_Educ_Level, method = "tcc"){
	...
	data.frame(mother_level, father_level, first_gen)
