...
SAVE OUTFILE='T:\Fact Book Committee\Data\Fall 2015\cBM001 for FB version two with Summer FTIC flag run 02-18-2016.sav'
  /COMPRESSED.

* Identify Duplicate Cases.
SORT CASES BY New_ID(A).
MATCH FILES
  /FILE=*
  /BY New_ID
  /FIRST=PrimaryFirst
...
*remove duplicates and save a new file.
...
SAVE OUTFILE='T:\Fact Book Committee\Data\Fall 2015\cBM001 for FB version two with Sum FTIC flag  NO DUPS run 02-18-2016.sav'
  /COMPRESSED.
